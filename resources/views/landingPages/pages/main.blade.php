...
<div class="container-fluid main-block-landing-center">
    ...
    <div class="row">
        <h3 class="text-center main-landing-text-cent">Er du igang med din efteruddannelse?<br> Registrer din supervision og hold styr på dine kurser.
        </h3>
    </div>
    <div class="row text-center">
        <a href="{{url('/register','psychologist')}}" class="href-button light-green">Er du psykolog? - Opret dig her!</a>
    </div>
    <div class="row">
...
<div class="container-fluid main-block-landing-footer">
    <div class="row">
        <h3 class="text-center footer-text-header"> Er du kursusudbyder eller supervisor?</h3>
    </div>
